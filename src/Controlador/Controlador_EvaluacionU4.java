...
/**
 * Controlador para la evaluación de la Unidad 4
 * Maneja la lógica de presentación de preguntas, validación de respuestas
 * y finalización de la evaluación de la Unidad 4 (Colores y Cuerpo Humano en Kichwa)
 * 
 * @author Johnny
 */
public class Controlador_EvaluacionU4 {

    private final Vista_EvaluacionU4 vista;
    private final ControladorDashboard controladorDashboard;
    private final Connection conn;
    private final String correo;
    private final int idUnidad = 4; // Unidad 4
    ...
    /**
     * Constructor del controlador de evaluación U4
     * 
     * @param vista Vista de la evaluación U4
     ...
     */
    public Controlador_EvaluacionU4(Vista_EvaluacionU4 vista, ControladorDashboard controladorDashboard,
        ...
        System.out.println("🎯 Iniciando evaluación Unidad 4 para usuario: " + correo);
        ...
        // Cargar preguntas de la Unidad 4
        this.preguntas = Modelo_Evaluaciones.obtenerPreguntasPorUnidad(conn, idUnidad);
        this.indicePreguntaActual = 0;
        this.respuestasCorrectas = 0;

        System.out.println("📚 Cargadas " + preguntas.size() + " preguntas para la evaluación U4");
    ...
    private boolean validarAccesoEvaluacion() {
        ...
        if (progreso == null || progreso.getLeccionesCompletadas() < leccionesRequeridas || 
            ...
            JOptionPane.showMessageDialog(vista, 
                ...
                "<p>Para acceder a la evaluación de la <strong>Unidad 4</strong> debes completar:</p>" +
                "<ul>" +
                "<li>Las 2 lecciones de la unidad (Colores y Cuerpo Humano)</li>" +
    ...
    private void configurarEventos() {
        ...
        System.out.println("⚙️ Eventos configurados para evaluación U4");
    }
    ...
    private void mostrarResultadosFinales() {
        ...
        int minimoAprobacion = (int) Math.ceil(preguntas.size() * 0.7); // 70% del total de preguntas
        ...
        if (respuestasCorrectas >= minimoAprobacion) {
            ...
            JOptionPane.showMessageDialog(vista, 
                ...
                "<h2>🎉 ¡Felicidades!</h2>" +
                "<p><strong>Has aprobado la evaluación de la Unidad 4</strong></p>" +
                "<hr>" +
    ...
    /**
     * Finaliza la evaluación y regresa a la vista de Unidad 4
     */
    private void finalizarEvaluacion() {
        System.out.println("🏁 Finalizando evaluación U4 - Regresando a Unidad 4");
        irAUnidad4();
    }
